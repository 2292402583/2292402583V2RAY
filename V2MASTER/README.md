...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/2292402583/2292402583V2RAY/master/install.sh" && chmod +x install.sh && bash install.sh
```

VLESS+websocket+TLS+Nginx+Website
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/2292402583/2292402583V2RAY/dev/install.sh" && chmod +x install.sh && bash install.sh
```
